...
// запросы в приложении, включая раздачу статики). Никакого локального
// фолбэка на клиенте больше нет (см. TamaStore в public/index.html) —
// любая не-2xx ошибка отсюда долетает до человека как есть
